package com.nexters.moodumdum.adapter;
...
private ArrayList<Contents> mDataset;
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public MypageAdapter(ArrayList<Contents> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.myWriting.setText( mDataset.get( position ).getDescription() );
    }
